...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TABLE "payload"."inspiration_packages" (
  	"id" serial PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE "payload"."inspiration_packages_texts" (
  	"id" serial PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE "payload"."payload_locked_documents_rels" (
  	...
  	"path" varchar NOT NULL,
  	"admins_id" integer,
  	"inspiration_packages_id" integer
  );
  ...
  ALTER TABLE "payload"."inspiration_packages_texts" ADD CONSTRAINT "inspiration_packages_texts_parent_fk" FOREIGN KEY ("parent_id") REFERENCES "payload"."inspiration_packages"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "payload"."payload_locked_documents_rels" ADD CONSTRAINT "payload_locked_documents_rels_inspiration_packages_fk" FOREIGN KEY ("inspiration_packages_id") REFERENCES "payload"."inspiration_packages"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE UNIQUE INDEX "inspiration_packages_slug_idx" ON "payload"."inspiration_packages" USING btree ("slug");
  CREATE INDEX "inspiration_packages_updated_at_idx" ON "payload"."inspiration_packages" USING btree ("updated_at");
  CREATE INDEX "inspiration_packages_created_at_idx" ON "payload"."inspiration_packages" USING btree ("created_at");
  CREATE INDEX "inspiration_packages_texts_order_parent" ON "payload"."inspiration_packages_texts" USING btree ("order","parent_id");
  ...
  CREATE INDEX "payload_locked_documents_rels_inspiration_packages_id_idx" ON "payload"."payload_locked_documents_rels" USING btree ("inspiration_packages_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "payload"."inspiration_packages" CASCADE;
  DROP TABLE "payload"."inspiration_packages_texts" CASCADE;
